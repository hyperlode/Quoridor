...
// var BOARD_PAWN_A_COLOR = "darkorchid";
// var BOARD_PAWN_A_COLOR = "lightsteelblue";
var BOARD_PAWN_A_COLOR = "lightskyblue";
//var BOARD_PAWN_B_COLOR = "lightsalmon";
var BOARD_PAWN_B_COLOR = "lightsalmon";
...
function buildUpBoard(svgElement){
	...
	//horizontal lines
	for (var i=0; i<10;i++){
		createLine(svgElement, 0*BOARD_SCALE + BOARD_X_OFFSET_SCALED, i*100*BOARD_SCALE + BOARD_Y_OFFSET_SCALED , 900*BOARD_SCALE + BOARD_X_OFFSET_SCALED, i*100*BOARD_SCALE + BOARD_Y_OFFSET_SCALED, BOARD_LINE_COLOR, 10*BOARD_SCALE);	
	}
	//createLine(svgElement, x1, y1, x2, y2, color, width)
	
	//vertical lines
	for (var i=0; i<10;i++){
		createLine(svgElement, i*100*BOARD_SCALE + BOARD_X_OFFSET_SCALED ,0*BOARD_SCALE + BOARD_Y_OFFSET_SCALED,  i*100*BOARD_SCALE + BOARD_X_OFFSET_SCALED, 900*BOARD_SCALE + BOARD_Y_OFFSET_SCALED, BOARD_LINE_COLOR, 10*BOARD_SCALE);	
	}
	
	//pawns init
	add_circle(svgElement, 450*BOARD_SCALE + BOARD_X_OFFSET_SCALED, 50*BOARD_SCALE + BOARD_Y_OFFSET_SCALED, 35*BOARD_SCALE, "pawn_A", BOARD_PAWN_A_COLOR);
	add_circle(svgElement, 450*BOARD_SCALE + BOARD_X_OFFSET_SCALED, 850*BOARD_SCALE + BOARD_Y_OFFSET_SCALED, 35*BOARD_SCALE, "pawn_B", BOARD_PAWN_B_COLOR);
